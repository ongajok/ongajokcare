...
export default function Introduction({ config }: IntroductionProps) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        >
          ...
          <div className="mt-8 pt-6 border-t border-slate-200/50 flex justify-end items-center gap-4">
            ...
            <div className="relative w-14 h-14 flex items-center justify-center select-none shrink-0">
              <img
                src="https://i.postimg.cc/C1m5Kqxm/ongajogganbyeonghyeobhoeuiin.png"
                alt="온가족간병협회 대표 직인"
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-[#1e3a8a] to-[#001c40] rounded-[24px] p-6 text-white border border-white/10 shadow-2xl flex flex-col justify-center relative overflow-hidden"
          >
